...
model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'grasp_recognition_lstm')
...
length_timeserie_frames = int(20)
min_conv_predict_prob = 0.3

CATEGORIES = ['Idle','IndexFingerExtension','Tripod','SmallDiameter','TipPinch']

threshold_time_serie_buffer_size = 5

flag_print_processing_time = False
